...
4. Seleccione **Región e idioma**, seleccione un idioma y seleccione **Establecer como predeterminado**.
     ...
     ![Cuadro de diálogo de configuración de idioma de Windows](media/supported-languages-countries-regions/power-bi-service-language-settings.png)
...
El idioma que elija para Power BI Desktop afectará al formato de presentación de los números y las fechas en los informes. 

* Seleccione un idioma al [descargar Power BI Desktop](https://powerbi.microsoft.com/desktop). 
...
* ¿Está usando una de las aplicaciones móviles de Power BI? Consulte [Idiomas admitidos en las aplicaciones móviles de Power BI](mobile-apps-supported-languages.md).
