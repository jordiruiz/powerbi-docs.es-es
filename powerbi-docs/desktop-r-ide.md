...
### <a name="enabling-an-external-r-ide"></a>Habilitar un IDE de R externo
...
### <a name="launching-an-r-ide-from-power-bi-desktop"></a>Iniciar un IDE de R desde Power BI Desktop
