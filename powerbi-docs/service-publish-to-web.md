...
> 
> [!IMPORTANT]
> Los administradores de Power BI pueden deshabilitar la capacidad de que los usuarios usen la característica Publicar en la web en el portal de administración. En **Configuración de inquilinos**, cambie **Publicar en la Web** a **Desactivado**. Esta configuración se aplica a todos los inquilinos. Para más información, visite el [portal de administración de Power BI](service-admin-portal.md).
> 
> 
