...
En un área de trabajo, seleccione la pestaña **Paneles** y, luego, elija el icono de **Ver relacionados** ![](media/service-related-content/power-bi-view-related-icon-new.png).
...
Con un panel abierto, seleccione ![](media/service-related-content/power-bi-view-related-new.png) en la barra de menús superior.
...
En un área de trabajo, seleccione la pestaña **Informes** y, luego, elija el icono de **Ver relacionados** ![](media/service-related-content/power-bi-view-related-icon-new.png).
...
En un área de trabajo, seleccione la pestaña **Conjunto de datos** y, luego, elija el icono de **Ver relacionados** ![](media/service-related-content/power-bi-view-related-icon-new.png).
