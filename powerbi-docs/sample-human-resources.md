...
El [cuadro de pregunta y respuestas](service-how-to-q-and-a.md) es donde se escribe una pregunta con lenguaje natural. Preguntas y respuestas reconoce las palabras que escribe y determina la ubicación del conjunto de datos donde se encuentra la respuesta.
