---
title: Realice un recorrido por los ejemplos disponibles con Power BI
description: Paquetes de contenido de ejemplo, archivos PBIX y conjuntos de datos de Excel para Power BI
services: powerbi
documentationcenter: 
author: mihart
manager: kfile
...
### <a name="customer-profitability-sample--mediasample-datasetspower-bi-cp2png"></a>Ejemplo de rentabilidad del cliente ![](media/sample-datasets/power-bi-cp2.png)
...
### <a name="human-resources-sample--mediasample-datasetspower-bi-hrpng"></a>Ejemplo de recursos humanos ![](media/sample-datasets/power-bi-hr.png)
...
### <a name="it-spend-analysis-sample-mediasample-datasetspower-bi-itpng"></a>Ejemplo de análisis de gastos de TI ![](media/sample-datasets/power-bi-it.png)
...
### <a name="opportunity-analysis-sample--mediasample-datasetspower-bi-oapng"></a>Ejemplo de análisis de oportunidades ![](media/sample-datasets/power-bi-oa.png)
...
### <a name="procurement-analysis-sample--mediasample-datasetspower-bi-papng"></a>Ejemplo de análisis de adquisiciones ![](media/sample-datasets/power-bi-pa.png)
[Realice un recorrido por el ejemplo de análisis de adquisiciones ](sample-procurement.md)

En este ejemplo sectorial, se analizan las principales métricas que un director financiero usa con sus ejecutivos, productos y clientes. Puede investigar qué factores afectan a la rentabilidad de la empresa

### <a name="retail-analysis-sample--mediasample-datasetspower-bi-rspng"></a>Ejemplo de análisis de minoristas ![](media/sample-datasets/power-bi-rs.png)
...
### <a name="sales-and-marketing-sample--mediasample-datasetspower-bi-smpng"></a>Ejemplo de marketing y ventas ![](media/sample-datasets/power-bi-sm.png)
...
### <a name="supplier-quality-sample--mediasample-datasetspower-bi-sqpng"></a>Ejemplo de análisis de calidad de proveedores ![](media/sample-datasets/power-bi-sq.png)
...
## <a name="how-to-get-the-samples"></a>Obtención de los ejemplos
...
## <a name="the-power-bi-samples-as-content-packs"></a>Ejemplos de Power BI como paquetes de contenido
...
### <a name="get-and-open-a-sample-content-pack-in-power-bi-service"></a>Obtención y apertura de un paquete de contenido de ejemplo en un servicio Power BI
...
## <a name="the-power-bi-samples-as-excel-files"></a>Ejemplos de Power BI como archivos de Excel
...
### <a name="optional-take-a-look-at-the-excel-samples-from-inside-excel-itself"></a>(Opcional) Consulta de los ejemplos de Excel desde Excel
...
## <a name="the-power-bi-samples-as-pbix-files"></a>Ejemplos de Power BI como archivos .pbix
