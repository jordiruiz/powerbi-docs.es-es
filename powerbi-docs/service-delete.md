...
* Si es el propietario del panel, puede quitarlo. Si compartió el panel con sus compañeros y quita el panel del área de trabajo de Power BI, este no se quitará del área de trabajo de Power BI de los compañeros.
...
2. Busque el panel que desea eliminar y seleccione el icono Eliminar ![](media/service-delete/power-bi-delete-icon.png). 
...
2. Busque el informe que desea eliminar y seleccione el icono Eliminar ![](media/service-delete/power-bi-delete-icon.png).   
...
2. Busque el libro que desea eliminar y seleccione el icono Eliminar ![](media/service-delete/power-bi-delete-report2.png).
...
Los conjuntos de datos se pueden eliminar. Sin embargo, al eliminar un conjunto de datos, también se eliminan todos los informes y los iconos de panel que contengan datos de este conjunto de datos.
...
2. Mantenga el puntero sobre la aplicación que desea eliminar y seleccione el icono Eliminar ![](media/service-delete/power-bi-delete-report2.png).
   ...
   Si quita una aplicación accidentalmente, tiene varias opciones para recuperarla.  Puede pedir al creador de la aplicación para la vuelva a enviar, puede encontrar el mensaje original con el vínculo a la aplicación, puede consultar su centro de notificaciones para ver si sigue apareciendo la notificación para esa aplicación o puede mirar en AppSource para su organización.
...
* [Quitar un panel de Favoritos](service-dashboard-favorite.md#unfavorite-a-dashboard)
