---
title: "Introducción a la aplicación móvil de Power BI en teléfonos Android"
...
---
# <a name="get-started-with-the-power-bi-mobile-app-on-android-phones"></a>Introducción a la aplicación móvil de Power BI en teléfonos Android
...
A continuación, en la aplicación de Power BI para teléfonos Android, podrá interactuar con los paneles y los informes locales y de la nube.
...
## <a name="get-started-with-the-power-bi-app-on-your-phone"></a>Introducción a la aplicación de Power BI en su teléfono
1. En la pantalla de inicio de su teléfono Android, abra la aplicación Power BI para Android.
...
2. Para ver los informes y paneles de Power BI, puntee **Power BI**.  
   ...
   ![Inicio de sesión en Power BI](media/mobile-android-app-get-started/power-bi-connect-to-login.png)
...
1. Pulse el botón de navegación global ![Botón de navegación global](media/mobile-android-app-get-started/power-bi-android-options-icon.png) en la esquina superior izquierda.
...
2. Pulse **Ejemplos de Reporting Services**. Después, abra la carpeta Informes de venta directa o Informes de ventas para explorar sus KPI y los informes móviles.
   ...
   ![Ejemplos de Reporting Services](media/mobile-android-app-get-started/power-bi-android-reporting-services-samples.png)

## <a name="search-for-a-dashboard-or-report"></a>Buscar un panel o informe
* Pulse la lupa en la esquina superior derecha ![Icono de búsqueda](media/mobile-android-app-get-started/power-bi-ipad-search-icon.png)y, después, escriba el término de búsqueda.
  
    ![Resultados de la búsqueda](media/mobile-android-app-get-started/power-bi-android-tablet-search.png)
...
![Panel de navegación izquierdo](media/mobile-android-app-get-started/power-bi-mobile-new-nav-no-numbers.png)
...
* Pulse **Favoritos**.
   ...
   ![Favoritos en el panel de navegación izquierdo](media/mobile-android-app-get-started/power-bi-android-favorite-left-nav.png)
...
Estas son algunas de las cosas que puede hacer en la aplicación de Power BI para teléfonos Android con los paneles e informes de Power BI, y con los informes los KPI del portal web del servidor de informes de Power BI o Reporting Services.
