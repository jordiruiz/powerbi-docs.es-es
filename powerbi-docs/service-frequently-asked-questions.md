...
## <a name="how-much-does-power-bi-cost"></a>¿Cuánto cuesta Power BI?
...
## <a name="power-bi-desktops-software-license-terms-say-you-may-install-and-use-one-copy-of-the-software-on-your-premises"></a>Los Términos de licencia del software de Power BI Desktop dicen "Puede instalar y usar una copia del software de forma local".
### <a name="does-this-mean-i-am-limited-to-one-copy-of-power-bi-desktop-for-the-entire-company"></a>¿Significa esto que estoy limitado a una copia de Power BI Desktop para toda la empresa?
Los derechos de uso de Power BI Desktop no le limitan a una copia de Power BI Desktop para toda la empresa. Cada usuario individual de la empresa puede instalar y usar una copia de forma local.
